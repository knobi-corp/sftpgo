...
func TestHTTPDBindingsFromEnv(t *testing.T) {
	...
	os.Setenv("SFTPGO_HTTPD__BINDINGS__1__BRANDING__WEB_ADMIN__NAME", "Descending Darkness Admin")
	os.Setenv("SFTPGO_HTTPD__BINDINGS__1__BRANDING__WEB_CLIENT__SHORT_NAME", "Descending Darkness")
